...
struct rect {
    ...
    [[nodiscard]] constexpr rect inset(uint32_t top, uint32_t right,
                                       uint32_t bottom, uint32_t left) const noexcept {
...
struct box_constraints {
    ...
    [[nodiscard]] static constexpr box_constraints tight(uint32_t w, uint32_t h) noexcept {
        return {w, w, h, h};
    }
...
[[nodiscard]] inline constexpr border_chars get_border_chars(border_style bs) noexcept {
    switch (bs) {
        ...
        case border_style::rounded:
            return {U'\x256D', U'\x256E', U'\x2570', U'\x256F',
                    U'\x2500', U'\x2502', U'\x253C',
                    U'\x252C', U'\x2534', U'\x251C', U'\x2524'};
        case border_style::heavy:
            return {U'\x250F', U'\x2513', U'\x2517', U'\x251B',
                    U'\x2501', U'\x2503', U'\x254B',
                    U'\x2533', U'\x253B', U'\x2523', U'\x252B'};
        case border_style::double_:
            return {U'\x2554', U'\x2557', U'\x255A', U'\x255D',
                    U'\x2550', U'\x2551', U'\x256C',
                    U'\x2566', U'\x2569', U'\x2560', U'\x2563'};
