...
namespace tapioca {
    ...
    inline key_mod operator|(key_mod a, key_mod b) {
        return static_cast<key_mod>(static_cast<uint8_t>(a) | static_cast<uint8_t>(b));
    }
    inline key_mod operator&(key_mod a, key_mod b) {
        return static_cast<key_mod>(static_cast<uint8_t>(a) & static_cast<uint8_t>(b));
    }
    inline bool has_mod(key_mod mods, key_mod m) {
        return (static_cast<uint8_t>(mods) & static_cast<uint8_t>(m)) != 0;
    }
